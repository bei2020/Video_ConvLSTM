...
flags.DEFINE_integer("epoch_evaluate", 20, "After this epochs are completed, evaluate loss.")
flags.DEFINE_boolean("batch_norm", False, "use batch normalization after each CNN layer")# works,PSNR better
